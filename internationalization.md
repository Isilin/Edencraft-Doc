...
A file resource can be created has a valid JSON file with one depth level. It has to be named following a specific pattern _&lt;name&gt;\_\_&lt;language&gt;\_\__&lt;country&gt;.json.
